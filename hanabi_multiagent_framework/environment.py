...
class HanabiParallelEnvironment:
    ...
    def reset_states(self,
        ...
        """
            Resets the terminal states and returns updated observations.
    ...
    def reset(self) -> Tuple[np.ndarray, np.ndarray]:
        """
            Resets the environment for a new game. Should be called once after the instantiation of this 
            env to retrieve initial observations.
